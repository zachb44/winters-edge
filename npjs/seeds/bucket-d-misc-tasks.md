...
- **DECISION (for Zach + Bucket C):** Treat **decks/fences and pool decks as quote-in-person only**,
  ...
  standard house washes); look at the rest in person.
...
| Item | Notes |
|---|---|
| Quote calculator tool | HTML or spreadsheet, built on Bucket C's logic. Removes live math = attacks the freeze. Fun build, not urgent. |
